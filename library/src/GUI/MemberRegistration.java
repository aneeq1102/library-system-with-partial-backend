...
//	}
	...
	MemberRegistration() {
		...
		lblfname.setFont(new Font(Font.SANS_SERIF,Font.PLAIN,14));
		lblfname.setBounds(x_pos_tb-280, y_pos_tb-offset, width, height);
		contentPane.add(lblfname);
		
		fnameField = new JTextField();
		fnameField.setBounds(140,y_pos_tb-offset,width,height);
		fnameField.setFont(new Font(Font.SANS_SERIF,Font.PLAIN,14));
		contentPane.add(fnameField);
		
		
		JLabel lbllname = new JLabel("Last Name:");
		lbllname.setFont(new Font(Font.SANS_SERIF,Font.PLAIN,14));
		lbllname.setBounds(x_pos_tb+50, y_pos_tb-offset, width, height);
		contentPane.add(lbllname);
		
		lnameField = new JTextField();
		lnameField.setBounds(470,y_pos_tb-offset,width,height);
		lnameField.setFont(new Font(Font.SANS_SERIF,Font.PLAIN,14));
