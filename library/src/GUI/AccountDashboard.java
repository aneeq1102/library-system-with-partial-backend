...
/*
	...
	//	btnOrderHistory.setBounds(217, 213, 194, 33);
		btnOrderHistory.setBounds(217,170, 194, 32);
		...
		btnAccountSecurity.setBounds(217, 213, 194, 33);
//	btnAccountSecurity.setBounds(217, 256, 194, 33);
		...
		btnManageAddresses.setBounds(217, 256, 194, 33);
	//	btnManageAddresses.setBounds(217, 300, 194, 32);
		...
		btnMembershipRenewal.setBounds(217, 300, 194, 32);
		//
	//	btnMembershipRenewal.setBounds(217, 343, 194, 36);
		...
		btnExit.setBounds(217, 343, 194, 36);
