...
public class DeleteSavedAddresse extends JFrame{
	...
	DeleteSavedAddresse(){
		...
		JLabel lblAddresseId = new JLabel("Addresse-id");
		lblAddresseId.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblAddresseId.setBounds(170, 155, 90, 23);
		contentPane.add(lblAddresseId);
		...
		submit.setBounds(155,220,100,22);
		contentPane.add(submit);
		
		JButton doReturn = new JButton("Return");
		doReturn.setBounds(280,220,100,22);
